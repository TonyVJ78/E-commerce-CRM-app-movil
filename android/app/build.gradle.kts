...
android {
    ...
    defaultConfig {
        ...
        applicationId = "bo.kantu.kantu_market"
    ...
    buildTypes {
        release {
            ...
            // Reglas propias para las clases de push provisioning de
            // flutter_stripe que R8 no puede resolver (ver proguard-rules.pro).
            proguardFiles(
